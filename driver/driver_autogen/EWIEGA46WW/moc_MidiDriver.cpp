...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_MidiDriver_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_MidiDriver_t qt_meta_stringdata_MidiDriver = {
    {
QT_MOC_LITERAL(0, 0, 10), // "MidiDriver"
QT_MOC_LITERAL(1, 11, 11), // "sendMessage"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 8), // "MidiData"
QT_MOC_LITERAL(4, 33, 4) // "data"

    },
    "MidiDriver\0sendMessage\0\0MidiData\0data"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_MidiDriver[] = {
...
void MidiDriver::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: { int _r = _t->sendMessage((*reinterpret_cast< MidiData(*)>(_a[1])));
...
QT_INIT_METAOBJECT const QMetaObject MidiDriver::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_MidiDriver.data,
